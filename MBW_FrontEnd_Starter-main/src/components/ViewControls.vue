...
function getParams() {
  ...
  console.log(">>>>>>>>>>>>>>>>>>>", route.query.view, route.params.viewType, props.doctype)
...
const quickFilters = createResource({
  url: "xxx.api.doc.get_quick_filters",
...
function create_or_update_default_view() {
  ...
  call(
    'xxx.xxx.doctype.xxx_view_settings.xxx_view_settings.create_or_update_default_view',
    {
      view: view.value,
    },
  ).then(() => {
