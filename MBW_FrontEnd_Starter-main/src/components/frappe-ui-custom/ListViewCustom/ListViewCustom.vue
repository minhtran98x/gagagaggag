...
import { reactive, computed, provide, watch, useSlots, ref, h } from "vue";
...
const emit = defineEmits(["update:selections", "update"]);

const handleTestEmits = () => {
  emit("update", "vu is awesome");
};
